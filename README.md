...
| ---------------------------------- | ------------------ | ----------------------------- | ------------------ |
| 1. Hola Mundo                      | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) | 1. Saludo                     | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) |
| 2. Ciclo de vida de un Servlet.    | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) | 2. Edad de una persona        | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) |
| 3. Formulario Simple               | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) | 3. Calculadora básica         | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) |
| 4. Formulario Complejo             | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) | 4. Monedero                   |                    |
| 5. Reservas                        |                    | 5. Mi nombre con cookies      |                    |
| 6. Registro                        |                    | 6. Operaciones básicas con... |                    |
| 7. Cabeceras de petición           | :heavy_check_mark: ![](https://img.shields.io/badge/build-failing-informational?style=flat&logo=<LOGO_NAME>&logoColor=white&color=db4949) | 7. Contador de visitas con... |                    |
